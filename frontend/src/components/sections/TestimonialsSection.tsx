        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  relative">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <button
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-yellow-500 hover:bg-yellow-600 rounded-full flex items-center justify-center transition-colors z-10"
            ...
            <button
              ...
              className="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-yellow-500 hover:bg-yellow-600 rounded-full flex items-center justify-center transition-colors z-10"
