    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-12">
          ...
          <button className="text-violet-600 hover:text-violet-800 text-sm font-medium bg-white px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-all cursor-pointer">
            View All Property →
          </button>
        </div>
