    ...
    <section className="py-16 bg-gray-50 relative overflow-hidden" style={{background:'url(/images/bg-shape-five.png) no-repeat center center/cover'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            {/* FAQ Badge */}
            <div className="inline-flex items-center px-4 py-2 bg-yellow-100 border border-yellow-300 rounded-full mb-8">
              <span className="text-sm font-medium text-yellow-800">FAQ</span>
            </div>
